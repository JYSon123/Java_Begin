package my.day05.b.FOR;
 ...
 public class ForTest1Main {
     ...
     */
		...
		for(int i=0; i<10; i+=1) {  // i+=1는 i=i+1; 와 같다
	    ...
	    */
		...
		for(int i=0; i<10; i++) {  // i+=1는 i=i+1; 와 같다
   ...
   */
    ...
    */
     ...
     */
       ...
       int n=0; //268번 줄에서 n을 출력을 하기 위해서 for문 바깥에서 선언해준다 (지역변수가 되지 않게)
       
       for(; n<5; n++) {
    	   
    	   System.out.println((n+1) + ".강준");

       }
       
       
       System.out.println("for문을 빠져 나온 이후 n : " + n);
