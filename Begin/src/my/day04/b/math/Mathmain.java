...
public class Mathmain {
	...
	public static void main(String[] args) {
		...
		// 2. >>> 올림에 대해서 알아본다. <<<
		// 54.0  ==> Math.ceil(54.0)  ==>  54.0  ==> 54
		// 54.1  ==> Math.ceil(54.1)  ==>  55.0  ==> 55
		// 54.9  ==> Math.ceil(54.9)  ==>  55.0  ==> 55
		
		double db3=54.0, db4=54.1, db5=54.9;
		System.out.println("\n=== 올림 한 후 ===");   // Math.ceil 은 올림이다.
		...
		// 3. >>> 내림에 대해서 알아본다. <<<
		// 54.0  ==> Math.floor(54.0)  ==>  54.0  ==> 54
		// 54.1  ==> Math.floor(54.1)  ==>  54.0  ==> 54
		// 54.9  ==> Math.floor(54.9)  ==>  54.0  ==> 54
		
		db3=54.0; db4=54.1; db5=54.9;
		System.out.println("\n=== 내림 한 후 ===");  // Math.floor은 내림이다.
		...
		System.out.println("a => " + Math.abs(a) + ", b => " + Math.abs(b)); // Math.abs은 내림값
		//a => 20, b => 30
