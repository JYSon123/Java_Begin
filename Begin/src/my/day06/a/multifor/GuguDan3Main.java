...
*/
	...
	public static void main(String[] args) {
		  ...
		  for(int dan=2; dan<10; dan+=4) {  // 4단씩 끊어야한다. 2단 다음에 6단이 오기 때문에 +4를 해준다.
			  	     						// 2단 부터 시작해서 5단까지 하는 것.
		                                    // 6단 부터 시작해서 9단까지 하는 것.
		  	  
			 for(int jul=1; jul<=9; jul++) { //jul이 단마다 곱해지는 수 입니다. 2*"1" 의 1
				   
				  for(int i=dan; i< dan+4; i++) {  //2단~5단 해주고, 6단 부터 9단을 할 수 있게 해준다.
