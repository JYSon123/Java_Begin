...
public class Main_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("=== 람다식(Lambda)을 사용하지 않은 것");
	
		InterAreaFunctional_1 triArea = new InterAreaFunctional_1() {
		...
		System.out.println("밑변이 10, 높이가 5인 삼각형의 면적은 " + triAreaSize);
		// 밑변이 10, 높이가 5인 삼각형의 면적은 25.0
     ...
     */
		...
		InterAreaFunctional_1 triArea2 = (x, y) -> x*y*0.5;
		
		double triAre2Size = triArea2.area(10, 5);
		
		System.out.println("밑변이 10, 높이가 5인 삼각형의 면적은 " + triAre2Size);
		...
		double db1 = objF.area(10, 5);
		System.out.println(db1);
		// 50.0
		
		// 7. return 이 있을 경우에는 { } 를 생략할 수 없다.
	//  InterAreaFunctional_1 objG = (x, y) -> return x+y; 오류이다.
		InterAreaFunctional_1 objG = (x, y) -> {return x+y;};
		double db2 = objG.area(10, 5);
		System.out.println(db2);
		
		
		// 8. return 문만 있는 단일 코드인 경우에는 { } 및 return 을 생략할 수 있다.
		InterAreaFunctional_1 objH = (x, y) -> x-y;
		double db3 = objH.area(10, 5);
