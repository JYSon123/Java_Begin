...
public class GujikjaCompanyMain {
	...
	public static void main(String[] args) {
		...
		Member[] mbrArr = new Member[10]; //추상클래스이다. 저장소만 해둔것
		// Member mbr = new Member(); 이것처럼 실체 객체를 생성하는것은 불가능. 
	...
	static void searchMenu(Scanner sc, GujikjaCompanyCtrl ctrl, Member[] mbrArr) {
